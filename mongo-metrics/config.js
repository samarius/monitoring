...
module.exports = {
    ...
    graphiteKeyTemplateGauges: 'databases.<%= cluster %>.<%= host %>.<%= metric %>.mean',
    graphiteKeyTemplateCounters: 'databases.<%= cluster %>.<%= host %>.<%= metric %>.count',

    servers: [
        {
            host: 'db1.example.com',
            shortName: 'db1', // optional
            cluster: 'main', // optional
            setMemberName: "db1.example.com:27017" // for replicate set member lookup
        },
        {
            host: 'db2.example.com',
            shortName: 'db2', // optional
            cluster: 'main', // optional
            setMemberName: "db2.example.com:27017" // for replicate set member lookup
        },
        {
            host: 'db3.example.com',
            shortName: 'db3', // optional
            cluster: 'main', // optional
            setMemberName: "db3.example.com:27017" // for replicate set member lookup
        },
    ],
